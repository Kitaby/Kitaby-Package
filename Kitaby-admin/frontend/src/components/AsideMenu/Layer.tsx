...
export default function AsideMenuLayer({ menu, className = '', ...props }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`aside-brand flex flex-row h-14 items-center justify-center dark:bg-slate-900`}
        >
          <div className="flex justify-center items-center lg:pl-6 xl:pl-0 ">
            <Image src={logo} className="h-12 w-12 dark:text-black" alt="Logo" />
          </div>
          <button
